...
This Privacy Policy explains how Chiasa handles user data in compliance with Discord’s Developer Terms and Policies.
...
- Message content (processed temporarily for moderation and commands)
- User IDs and Server IDs
- Basic server activity (joins, leaves, roles)
...
- Detect spam, scams, and harmful content
- Provide AI-powered moderation and safety scanning
- Execute commands and automation features
- Manage roles, verification, and server settings
...
Some non-sensitive data (such as server settings or user preferences) may be stored to ensure proper bot functionality.
